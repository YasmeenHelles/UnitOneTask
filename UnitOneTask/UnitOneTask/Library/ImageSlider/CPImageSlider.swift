...
//                    imageV.image = UIImage(named:images.last!)
                    ...
                    imageV.sd_setImage(with: URL(string: images.last!)!, placeholderImage: UIImage(named: "10000-2")!, options: SDWebImageOptions.refreshCached)
...
//                    imageV.image = UIImage(named:images.first!)
                    imageV.sd_setImage(with: URL(string: images.first!)!, placeholderImage: UIImage(named: "10000-2")!, options: SDWebImageOptions.refreshCached)
				}
				else
				{
//                    imageV.image = UIImage(named:images[index - 1])
                    imageV.sd_setImage(with: URL(string: images[index - 1])!, placeholderImage: UIImage(named: "10000-2")!, options: SDWebImageOptions.refreshCached)
				}
			}
			else
			{
//                imageV.image = UIImage(named:images[index])
                imageV.sd_setImage(with: URL(string: images[index])!, placeholderImage: UIImage(named: "10000-2")!, options: SDWebImageOptions.refreshCached)
			}
